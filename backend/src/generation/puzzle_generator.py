...
def _step2_category_brainstorm(
    ...
    prompt = (
        ...
        "  5. DOMAIN DIVERSITY — the selected categories must span at least 3 distinct\n"
        "     knowledge domains (e.g. sport, music, food, science, language, history,\n"
        "     geography, pop culture, nature, technology, art, literature).\n"
